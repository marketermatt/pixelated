...
function pts_enqueue_js() {
    ...
    wp_enqueue_script( 'validator', trailingslashit(PARENT_URL) . 'js/validator.js', '', '1.0.0', true );
    ...
    //if(is_page_template( 'pts-documentation.php' ))
        wp_enqueue_script( 'fancyselect', trailingslashit(PARENT_URL) . 'js/fancySelect.js', array('jquery'), '1.4.0', false );
}
