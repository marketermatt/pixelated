  ...
  ot_register_settings( array(
      array(
        ...
        'pages'               => array( 
          array(
            'id'              => 'ot_theme_options',
            'page_title'      => apply_filters( 'ot_theme_options_page_title', __( PTS_THEME_NAME, 'option-tree' ) ),
            'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( THEME_ADMIN_LINK_NAME, 'option-tree' ) ),
            'capability'      => apply_filters( 'ot_theme_options_capability', 'edit_theme_options' ),
            'menu_slug'       => 'ot-theme-options',
            'icon_url'        => get_template_directory_uri().'/images/icon.png',
            'position'        => '58.925',
