...
function custom_theme_options()
{
    ...
    $custom_settings = array(
        ...
        'settings' => array(
            ...
            array(
                'id' => 'pts_registration_url',
                'label' => __('Registration form URL.', PTS_DOMAIN),
                'desc' => __('Used in the login page template', PTS_DOMAIN),
                'std' => '',
                'type' => 'text',
                'section' => 'general',
                'rows' => '',
            ...
            array(
                'id' => 'pts_main_menu_bg',
                'label' => __('Main Menu Background Color', PTS_DOMAIN),
                'desc' => '',
                'std' => '#252525',
                'type' => 'colorpicker',
                'section' => 'color',
            ...
            array(
                'id' => 'pts_widget_title_bg',
                'label' => __('Widget area title background', PTS_DOMAIN),
                'desc' => '',
                'std' => '#5da4e2',
                'type' => 'colorpicker',
                'section' => 'color',
            ...
            array(
                'id' => 'pts_menu_type',
                'label' => __('Menu Type', PTS_DOMAIN),
                'desc' => 'What kind of menu should be used. This can be over written per page',
                'std' => '',
                'type' => 'select',
                'choices' => array(
                    array(
                        'value' => '1',
                        'label' => __('Normal Header', PTS_DOMAIN),
                        'src' => ''
                    ),
                    array(
                        'value' => '2',
                        'label' => __('Overlayed Header', PTS_DOMAIN),
                        'src' => ''
                    )
                ),
                'section' => 'header',
            ...
            array(
                'id' => 'pts_shop_download_button',
                'label' => __('Shop Download Button Color', PTS_DOMAIN),
                'desc' => __('',PTS_DOMAIN),
                'std' => '#95b52e',
                'type' => 'colorpicker',
                'section' => 'shop',
            ...
            array(
                'id' => 'pts_shop_free_download_button',
                'label' => __('Shop Free Download Button Color', PTS_DOMAIN),
                'desc' => __('',PTS_DOMAIN),
                'std' => '#484848',
                'type' => 'colorpicker',
                'section' => 'shop',
            ...
            array(
                'id' => 'pts_show_cart',
                'label' => __('Show Shopping Cart?', PTS_DOMAIN),
                'desc' => '',
                'std' => '1',
                'type' => 'select',
                'section' => 'shop',
        ...
        array(
            ...
            array(
                'id' => 'pts_project_count_per_line',
                'label' => __('Project count per row', PTS_DOMAIN),
                'desc' => '',
                'std'         => '3',
                'type'        => 'select',
                'section'     => 'categories',
                ...
                'choices' => array(
                    array(
                        'value' => '3',
                        'label' => __('3', PTS_DOMAIN),
                        'src' => ''
                    ),
                    array(
                        'value' => '4',
                        'label' => __('4', PTS_DOMAIN),
                        'src' => ''
                    ),
                    array(
                        'value' => '6',
                        'label' => __('6', PTS_DOMAIN),
                        'src' => ''
                    )
                )
            )
